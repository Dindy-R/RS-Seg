...
from models.BotNet.botnet import BoTStack
...
class ResNet_Botnet(nn.Module):
    ...
    """
    # pylint: disable=unused-variable
    def __init__(self, fmap_size, block, layers, radix=1, groups=1, bottleneck_width=64,
                 num_classes=1000, dilated=False, dilation=1,
                 deep_stem=False, stem_width=64, avg_down=False,
                 rectified_conv=False, rectify_avg=False,
                 avd=False, avd_first=False,
                 final_drop=0.0, dropblock_prob=0, botnet: bool=False,
                 last_gamma=False, norm_layer=nn.BatchNorm2d):
        self.cardinality = groups
        self.bottleneck_width = bottleneck_width
        # ResNet-D params
        ...
        super(ResNet_Botnet, self).__init__()
        self.rectified_conv = rectified_conv
        self.rectify_avg = rectify_avg
        # if rectified_conv:
        #     from rfconv import RFConv2d
