...
# -----------------------------------------------------------------------------------#
Origin_SegmentationClass_path = "D:/data_set/ST/label/label"
Out_SegmentationClass_path = "D:/data_set/ST/labels"
...
Origin_Point_Value = np.array([100, 200, 300, 400, 500, 600, 700, 800])

Out_Point_Value    = np.array([1, 2, 3, 4, 5, 6, 7, 0])
